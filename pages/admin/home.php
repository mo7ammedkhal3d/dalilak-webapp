...
foreach ($categories as $category) { ?>
    <section>
        <div class="special-dishes">
            ...
            <h1>معالم مدينة المكلا التاريخية </h1>
            <h1>تعتبر أحد أشهر الأماكن للبحث في حقائب الماضي السحيق</h1>
            <a href='HistoricalLandmarks?categoryId=<?php echo $category['Id'] ?>' class="btn btn-outline-info w-25 float-start fw-bold my-4">رؤية المزيد</a>
            ...
            <div class="meals-slider">
                <div class="inner row-cols-1 row-cols-sm-2  row-cols-md-3 row-cols-lg-4 edit-row">
                    <?php
                    ...
                    foreach ($rows as $row) { ?>
                        <div class="col slide">
                            <div class="card edit-card">
                                <img src="./assets/img/hussangwazi.jpg" alt="Loadding">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php echo $row['Name'] ?>
                                    </h5>
